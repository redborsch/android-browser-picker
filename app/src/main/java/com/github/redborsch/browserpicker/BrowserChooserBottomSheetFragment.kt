...
class BrowserChooserBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private fun BottomSheetDialog.setUp() {
    ...
    private fun FragmentBrowserChooserBinding.setUp() {
        BrowserChooserUiHelper(viewModel)
            .setUp(
                requireActivity(),
                this,
                // We cannot use view lifecycle owner at this stage...
                // We can potentially use viewLifecycleOwnerLiveData, but seems like an overkill here.
